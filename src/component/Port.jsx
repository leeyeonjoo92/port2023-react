...
const Port = () => {
	// useRef() : 함수형 컴포넌트에서 DOM 요소에 접근하거나 특정값들을 기억하고 관리하는 기능
	// 클래스 컴포넌트의 this와 비슷한 역할
	// scrollTrigger 가로모드를 사용하기위해 각 width값을 알아내기 위해 사용
	...
	useEffect(() => {
		...
		// pin-spacer가 생기면서 Port 컴포넌트 이외의
		// 다른 컴포넌트에 영향을 끼치기 때문에 변수로 만들어줌
